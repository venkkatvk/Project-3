...
// Technology Stack: React Workspace Root Engine (App.jsx)

import React, { useState } from 'react';
import IngressSecuritySimulator from './components/IngressSecuritySimulator';

export default function App() {
  const [gatewayMetrics, setGatewayMetrics] = useState(null);
  const [liveTerminalLogs, setLiveTerminalLogs] = useState([]);

  // Centralized async dispatcher to communicate across cross-origin network ports
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 p-8">
      ...
      <header className="mb-8 border-b border-slate-800 pb-4">
        <h1 className="text-2xl font-black text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 to-cyan-400 font-mono tracking-tight">
